...
const (
	...
	HTTPUpstreamProfileClaudeOAuthCompanion HTTPUpstreamProfile = "claude_oauth_companion"
)
...
func HTTPUpstreamProfileFromContext(ctx context.Context) HTTPUpstreamProfile {
	...
	switch profile {
	case HTTPUpstreamProfileOpenAI, HTTPUpstreamProfileClaudeOAuthCompanion:
		return profile
	default:
		return HTTPUpstreamProfileDefault
	}
