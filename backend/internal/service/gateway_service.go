...
func safeHeaderValueForLog(key string, v string) string {
	...
	switch key {
	case "authorization", "x-api-key", strings.ToLower(claudeUpstreamApprovalTokenHeader):
...
type GatewayService struct {
	...
	claudeUpstreamApproval *claudeUpstreamApprovalGate
...
func NewGatewayService(
	...
	svc := &GatewayService{
		...
		claudeUpstreamApproval: newClaudeUpstreamApprovalGateFromEnv(),
	}
